...
// The showplayer/tonytonyshopper pill palette: colors are handed out to a
// section's fields in this fixed order (1, 2, 3, …), and a range's Min and
// Max share one color. Meaning does not pick the color — position does.
