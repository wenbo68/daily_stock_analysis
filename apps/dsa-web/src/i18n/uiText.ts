...
const zh = {
  ...
  'tiered.altForm.emptyHint': '先选择或输入股票代码',
  'tiered.pill.capital': '本金 {value}',
  'tiered.pill.risk': '单笔风险 {value}%',
  'tiered.pill.dateStart': '始于 {value}',
  'tiered.pill.dateEnd': '止于 {value}',
  'tiered.pill.sharesMin': '股数 ≥ {value}',
  'tiered.pill.sharesMax': '股数 ≤ {value}',
  'tiered.altFilter.date': '日期（yyyy/mm/dd）',
  'tiered.altFilter.dateStart': '开始',
  'tiered.altFilter.dateEnd': '结束',
  'tiered.altFilter.direction': '结论',
  'tiered.altFilter.any': '不限',
  'tiered.altFilter.shares': '建议股数',
  'tiered.altFilter.min': '最少',
  'tiered.altFilter.max': '最多',
  'tiered.altFilter.empty': '未筛选',
  'tiered.altHistory.shares': '{value} 股',
  'tiered.altHistory.page': '第 {page} / {total} 页',
...
const en: Record<UiTextKey, string> = {
  ...
  'tiered.altForm.emptyHint': 'Pick or type a ticker first',
  'tiered.pill.capital': 'Capital {value}',
  'tiered.pill.risk': 'Risk {value}%',
  'tiered.pill.dateStart': 'From {value}',
  'tiered.pill.dateEnd': 'To {value}',
  'tiered.pill.sharesMin': 'Shares ≥ {value}',
  'tiered.pill.sharesMax': 'Shares ≤ {value}',
  'tiered.altFilter.date': 'Date (yyyy/mm/dd)',
  'tiered.altFilter.dateStart': 'Start',
  'tiered.altFilter.dateEnd': 'End',
  'tiered.altFilter.direction': 'Verdict',
  'tiered.altFilter.any': 'Any',
  'tiered.altFilter.shares': 'Shares',
  'tiered.altFilter.min': 'Min',
  'tiered.altFilter.max': 'Max',
  'tiered.altFilter.empty': 'No filters',
  'tiered.altHistory.shares': '{value} shares',
  'tiered.altHistory.page': 'Page {page} of {total}',
